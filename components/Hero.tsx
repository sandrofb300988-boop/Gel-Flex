...
export const Hero: React.FC = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-brand-light">
      ...
      <div 
        ref={blobRef}
        className="absolute top-[-10%] right-[-5%] w-[300px] h-[300px] sm:w-[600px] sm:h-[600px] bg-brand-medium/20 rounded-full blur-3xl opacity-60 pointer-events-none will-change-transform"
      ></div>
      
      <div className="max-w-7xl mx-auto">
        <div className="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32 min-h-[75vh] md:min-h-[85vh] flex items-center">
          <main className="mt-8 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="text-center">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-white border border-brand-medium shadow-sm text-brand-primary text-[10px] sm:text-xs font-bold tracking-widest uppercase mb-6">
              ...
              <h1 
                ref={titleRef}
                className="text-4xl sm:text-5xl tracking-tight text-brand-dark md:text-6xl lg:text-7xl font-serif mb-6 leading-[1.1] opacity-0 translate-y-12 transition-all duration-1000 ease-out"
              >
                <span className="block font-medium">Pele de seda,</span>
                <span className="block text-brand-primary italic">sem sair de casa.</span>
              </h1>
              
              <p className="mt-6 text-base sm:text-lg text-gray-600 sm:mt-8 sm:max-w-xl sm:mx-auto md:mt-8 font-sans font-light leading-relaxed sm:leading-loose tracking-wide px-2">
              ...
              <div className="mt-8 sm:mt-12 flex justify-center w-full">
                <a
                  ...
                  className="group w-full sm:w-auto flex items-center justify-center px-8 sm:px-10 py-4 sm:py-5 border border-transparent text-lg font-bold rounded-full text-white bg-brand-primary hover:bg-brand-dark transition-all duration-300 shadow-lg hover:shadow-brand-primary/30 animate-subtle-pulse hover:animate-none cursor-pointer active:scale-95"
                >
                  Quero Experimentar
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 text-sm text-gray-500">
                 ...
                 <div className="flex flex-col text-center sm:text-left">
                    <div className="flex justify-center sm:justify-start text-brand-accent">
      ...
      {/* Creative Text Section replacing Image - Responsive fix */}
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-[45%] lg:h-full lg:mt-0 mt-8 p-4 lg:p-0 flex items-center justify-center">
         <div className="relative h-auto w-full max-w-lg lg:max-w-none lg:h-full rounded-[2.5rem] lg:rounded-none lg:rounded-bl-[5rem] overflow-hidden bg-white/40 backdrop-blur-sm border border-white/50 shadow-xl lg:shadow-none flex flex-col justify-center p-8 sm:p-12 lg:p-20 min-h-[400px] lg:min-h-0">
            {/* Background Texture */}
            <div className="absolute inset-0 bg-gradient-to-br from-brand-medium/20 via-transparent to-brand-primary/10"></div>
            
            <div className="relative z-10">
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-6xl text-brand-dark mb-6 sm:mb-8 leading-tight">
                <span className="italic text-brand-primary opacity-80 block text-xl sm:text-2xl lg:text-3xl mb-2 font-sans font-light">Manifesto</span>
                Sua beleza não precisa doer.
              </h2>
              <div className="w-16 sm:w-20 h-1 bg-brand-primary mb-6 sm:mb-8"></div>
              ...
              <p className="text-base sm:text-lg text-brand-dark font-medium italic">
                — Menos química.<br/>
                — Menos lixo.<br/>
                — Mais você.
              </p>
