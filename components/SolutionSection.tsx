      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 order-2 lg:order-1 relative">
                <div className="relative rounded-[3rem] overflow-hidden shadow-xl bg-brand-primary p-10 text-white flex flex-col justify-between h-[600px] border border-brand-accent/30">
                    ...
                    <div className="relative z-10">
                        <span className="text-brand-medium font-bold tracking-widest text-sm uppercase mb-2 block">O Segredo</span>
                        <h2 className="text-5xl font-serif leading-none mb-6">
                            Da sua <br/>
                    ...
                    <div className="relative z-10 space-y-6">
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-full border border-white/30 flex items-center justify-center font-serif text-2xl italic">1</div>
                            <p className="text-lg font-light text-brand-light">Ingredientes que você pode comer.</p>
                        </div>
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-full border border-white/30 flex items-center justify-center font-serif text-2xl italic">2</div>
                            <p className="text-lg font-light text-brand-light">Zero plásticos ou descartáveis.</p>
                        </div>
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-full border border-white/30 flex items-center justify-center font-serif text-2xl italic">3</div>
                            <p className="text-lg font-light text-brand-light">Resultado de salão, custo de centavos.</p>
                        </div>
                    </div>

                    <div className="relative z-10 pt-8 border-t border-white/20 mt-auto">
                        <p className="font-serif italic text-2xl text-brand-medium text-center">
            ...
            <div className="lg:col-span-7 order-1 lg:order-2">
                ...
                <div className="space-y-6">
                    <div className="flex items-start p-6 bg-white rounded-3xl shadow-sm border border-brand-light hover:shadow-md transition">
                        ...
                        <div className="ml-6">
                            <h4 className="font-bold text-brand-dark text-xl font-serif">Gel Bio-Adesivo</h4>
                    ...
                    <div className="flex items-start p-6 bg-white rounded-3xl shadow-sm border border-brand-light hover:shadow-md transition">
                        ...
                        <div className="ml-6">
                            <h4 className="font-bold text-brand-dark text-xl font-serif">Termo-Ativação Suave</h4>
                            <p className="text-gray-600 mt-2 leading-relaxed">
